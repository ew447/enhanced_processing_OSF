...
const study = lab.util.fromObject({
  ...
  "metadata": {
    "title": "Session_2",
    "description": "Better footer and motivation formatting.",
    "repository": "",
    "contributors": ""
  },
  "files": {},
              ...
              "items": [
                {
                  "required": true,
                  "type": "html",
                  "content": "\u003Cheader\u003E\r\n  \u003Ch1 id=\"welcomeHeader\"\u003ESession 2: Memorising Object Locations and Colours\u003C\u002Fh1\u003E\r\n\u003C\u002Fheader\u003E\r\n\r\n",
                  "name": ""
                },
                {
                  "required": true,
              ...
              "items": [
                {
                  ...
                  "content": "\u003Cp\u003E This experiment will take approximately \u003Cb\u003E 60 minutes \u003C\u002Fb\u003E to complete. Please follow all instructions carefully. \u003C\u002Fp\u003E\n    \n \u003Cp\u003EDuring this study, we will first ask you to complete a computerised task where you have to remember the colour and location of the 45 objects you saw during the previous session.  We will measure your ability to discriminate between different colours and locations and at the same time we will test your memory for colour and location. This part of the study will take approximately 30 minutes. After this, you will perform a matching task where you match the location and colour of the object on the right to that on the left. This part of the study will take approximately 20 minutes. There is also a short questionnaire about your motivation at the end of the session. We can pay you for your time. \u003C\u002Fp\u003E\n\nPlease ensure that you complete this experiment using a \u003Cb\u003E computer. \u003C\u002Fb\u003EIf you are currently using a phone or tablet, close this window and return on a computer. \u003C\u002Fp\u003E \n\n\u003Cb\u003EDuring this task, we ask you to sit in an upright position and have the screen at arm's length at all times. We also advise you to complete this task in fullscreen to mode to ensure it runs properly on your screen. \u003C\u002Fb\u003E\u003C\u002Fp\u003E"
                }
              ],
              "scrollTop": true,
              "submitButtonText": "Next→",
...
const ID_filtered_data = this.options.datastore.data.filter(
  row => row.sender === 'Participant Code'
);
          ...
          "items": [
            {
              "required": true,
              "type": "html",
              "content": "\u003Cheader\u003E\r\n  \u003Ch1 id=\"instructionHeader\"\u003ESection 1: Memory Test\u003C\u002Fh1\u003E\r\n\u003C\u002Fheader\u003E\r\n\u003Cp style=\"font-size: 24px; position: center\"\u003E You are about to begin the memory test blocks. \u003Cb\u003E This will check how well you can remember the location and colour of the objects that you saw during Session 1. \u003C\u002Fb\u003E\u003C\u002Fp\u003E\r\n  \r\n\u003Cp style=\"font-size: 24px; position: center\"\u003E  There are 45 objects in total. Please take a short break after every 15 objects, or as needed. \u003C\u002Fp\u003E\r\n  \r\n\u003Cp style=\"font-size: 24px; position: center\"\u003E Click \"Start\" to begin. \u003C\u002Fp\u003E",
              "name": ""
            }
          ],
          "scrollTop": true,
...
const location_filtered_data = this.options.datastore.data.filter(
  row => row.sender === 'Location_Recall_LTMD' && row.ended_on !== 'skipped' && row.block === this.parameters.block
);

// filter by Colour_Recall
const color_filtered_data = this.options.datastore.data.filter(
  row => row.sender === 'Colour_Recall_LTMD' && row.ended_on !== 'skipped' && row.block === this.parameters.block
);
...
if (this.state.set_counter <= 1) {
    document.getElementById('messageBlock').innerHTML = "<p> Great! When you are ready we will show you the next set of fifteen previously seen objects. </p> <p> Click 'Next' to move on.</p>";
} else if (this.state.set_counter === 2) {
    var messageEnd = "<p> Well done! You have now completed the memory task. The next section will ask you to complete a brief matching task </p> <p> Click 'Next' when you are ready to move on. </p>";
    document.getElementById('messageEnd').innerHTML = messageEnd;
}
}
                },
          ...
          "items": [
            {
              "required": true,
              "type": "html",
              "content": "\u003Cheader\u003E\n  \u003Ch1 id=\"instructionHeader\"\u003ESection 2: Matching Task\u003C\u002Fh1\u003E\n\u003C\u002Fheader\u003E\n\u003Cp style=\"font-size: 24px; position: center\"\u003E You are about to begin the matching task where you will see two objects at once. Both of these objects will be identical except for their colour and their location. We will measure how accurately you are able to match the two objects in terms of their location and colour. \u003C\u002Fp\u003E\n\n\u003Cp style=\"font-size: 24px; position: center\"\u003E You will see \u003Cb\u003E 45 objects \u003C\u002Fb\u003E in total (three sets of 15 objects, with breaks between sets \u003C\u002Fp\u003E\n  \n\u003Cp style=\"font-size: 24px; position: center\"\u003E Click \"Start\" to begin. \u003C\u002Fp\u003E",
              "name": ""
            }
          ],
          "scrollTop": true,
...
// prepare presentation of wheel (for location and color)
// radius for circles
this.state.radius_left  = window.scaling_rectx 
this.state.radius1_left =  this.state.radius_left - 1 
this.state.radius2_left =  this.state.radius_left - 20
this.state.radius3_left =  this.state.radius_left - 21 // if you make this subtracted number larger, the grey area should increase

this.state.diameter_left = this.state.radius_left * 2

// prepare image size
this.state.imgHeight_left = window.scaling_rectx * 0.72 // we present image squared, so this is enough
// this.state.imgWidth = 180

// shift the image position by this value (so it is relative to the center of the circles)
this.state.imgShift_left = this.state.radius_left - this.state.imgHeight_left/2
...
// prepare presentation of wheel (for location and color)
// radius for circles
this.state.radius_right  = window.scaling_rectx 
this.state.radius1_right =  this.state.radius_right - 1 
this.state.radius2_right =  this.state.radius_right - 20
this.state.radius3_right =  this.state.radius_right - 21 // if you make this subtracted number larger, the grey area should increase

this.state.diameter_right = this.state.radius_right * 2

// prepare image size
this.state.imgHeight_right = window.scaling_rectx * 0.72 // we present image squared, so this is enough
// this.state.imgWidth = 180

// shift the image position by this value (so it is relative to the center of the circles)
this.state.imgShift_right = this.state.radius_right - this.state.imgHeight_right/2


}
            },
            "title": "Block task sequence",
            "content": [
              {
                "type": "lab.flow.Loop",
                "templateParameters": [
                  {
                    "block_n": "1",
                    "image_left": "image_50.png",
                    "hue_left": "337",
                    "theta_left": "49",
                    "image_right": "image_50.png",
                    "theta_right": "49"
                  },
                  {
                    "block_n": "1",
                    "image_left": "image_51.png",
                    "hue_left": "49",
                    "theta_left": "241",
                    "image_right": "image_51.png",
                    "theta_right": "241"
                  },
                  {
                    "block_n": "1",
                    "image_left": "image_52.png",
                    "hue_left": "313",
                    "theta_left": "193",
                    "image_right": "image_52.png",
                    "theta_right": "193"
                  },
                  {
                    "block_n": "1",
                    "image_left": "image_53.png",
                    "hue_left": "217",
                    "theta_left": "265",
                    "image_right": "image_53.png",
                    "theta_right": "265"
                  },
                  {
                    "block_n": "1",
                    "image_left": "image_54.png",
                    "hue_left": "25",
                    "theta_left": "289",
                    "image_right": "image_54.png",
                    "theta_right": "289"
                  },
                  {
                    "block_n": "1",
                    "image_left": "image_55.png",
                    "hue_left": "121",
                    "theta_left": "313",
                    "image_right": "image_55.png",
                    "theta_right": "313"
                  },
                  {
                    "block_n": "1",
                    "image_left": "image_56.png",
                    "hue_left": "97",
                    "theta_left": "337",
                    "image_right": "image_56.png",
                    "theta_right": "337"
                  },
                  {
                    "block_n": "1",
                    "image_left": "image_57.png",
                    "hue_left": "73",
                    "theta_left": "169",
                    "image_right": "image_57.png",
                    "theta_right": "169"
                  },
                  {
                    "block_n": "1",
                    "image_left": "image_58.png",
                    "hue_left": "265",
                    "theta_left": "25",
                    "image_right": "image_58.png",
                    "theta_right": "25"
                  },
                  {
                    "block_n": "1",
                    "image_left": "image_59.png",
                    "hue_left": "145",
                    "theta_left": "145",
                    "image_right": "image_59.png",
                    "theta_right": "145"
                  },
                  {
                    "block_n": "1",
                    "image_left": "image_60.png",
                    "hue_left": "1",
                    "theta_left": "1",
                    "image_right": "image_60.png",
                    "theta_right": "1"
                  },
                  {
                    "block_n": "1",
                    "image_left": "image_61.png",
                    "hue_left": "241",
                    "theta_left": "121",
                    "image_right": "image_61.png",
                    "theta_right": "121"
                  },
                  {
                    "block_n": "1",
                    "image_left": "image_62.png",
                    "hue_left": "289",
                    "theta_left": "217",
                    "image_right": "image_62.png",
                    "theta_right": "217"
                  },
                  {
                    "block_n": "1",
                    "image_left": "image_63.png",
                    "hue_left": "169",
                    "theta_left": "73",
                    "image_right": "image_63.png",
                    "theta_right": "73"
                  },
                  {
                    "block_n": "1",
                    "image_left": "image_64.png",
                    "hue_left": "193",
                    "theta_left": "97",
                    "image_right": "image_64.png",
                    "theta_right": "97"
                  },
                  {
                    "block_n": "2",
                    "image_left": "image_65.png",
                    "hue_left": "1",
                    "theta_left": "121",
                    "image_right": "image_65.png",
                    "theta_right": "121"
                  },
                  {
                    "block_n": "2",
                    "image_left": "image_66.png",
                    "hue_left": "241",
                    "theta_left": "193",
                    "image_right": "image_66.png",
                    "theta_right": "193"
                  },
                  {
                    "block_n": "2",
                    "image_left": "image_67.png",
                    "hue_left": "145",
                    "theta_left": "25",
                    "image_right": "image_67.png",
                    "theta_right": "25"
                  },
                  {
                    "block_n": "2",
                    "image_left": "image_68.png",
                    "hue_left": "97",
                    "theta_left": "97",
                    "image_right": "image_68.png",
                    "theta_right": "97"
                  },
                  {
                    "block_n": "2",
                    "image_left": "image_69.png",
                    "hue_left": "217",
                    "theta_left": "169",
                    "image_right": "image_69.png",
                    "theta_right": "169"
                  },
                  {
                    "block_n": "2",
                    "image_left": "image_70.png",
                    "hue_left": "289",
                    "theta_left": "289",
                    "image_right": "image_70.png",
                    "theta_right": "289"
                  },
                  {
                    "block_n": "2",
                    "image_left": "image_71.png",
                    "hue_left": "193",
                    "theta_left": "1",
                    "image_right": "image_71.png",
                    "theta_right": "1"
                  },
                  {
                    "block_n": "2",
                    "image_left": "image_72.png",
                    "hue_left": "337",
                    "theta_left": "313",
                    "image_right": "image_72.png",
                    "theta_right": "313"
                  },
                  {
                    "block_n": "2",
                    "image_left": "image_73.png",
                    "hue_left": "25",
                    "theta_left": "49",
                    "image_right": "image_73.png",
                    "theta_right": "49"
                  },
                  {
                    "block_n": "2",
                    "image_left": "image_74.png",
                    "hue_left": "49",
                    "theta_left": "241",
                    "image_right": "image_74.png",
                    "theta_right": "241"
                  },
                  {
                    "block_n": "2",
                    "image_left": "image_75.png",
                    "hue_left": "73",
                    "theta_left": "265",
                    "image_right": "image_75.png",
                    "theta_right": "265"
                  },
                  {
                    "block_n": "2",
                    "image_left": "image_76.png",
                    "hue_left": "169",
                    "theta_left": "145",
                    "image_right": "image_76.png",
                    "theta_right": "145"
                  },
                  {
                    "block_n": "2",
                    "image_left": "image_77.png",
                    "hue_left": "121",
                    "theta_left": "337",
                    "image_right": "image_77.png",
                    "theta_right": "337"
                  },
                  {
                    "block_n": "2",
                    "image_left": "image_78.png",
                    "hue_left": "265",
                    "theta_left": "73",
                    "image_right": "image_78.png",
                    "theta_right": "73"
                  },
                  {
                    "block_n": "2",
                    "image_left": "image_79.png",
                    "hue_left": "313",
                    "theta_left": "217",
                    "image_right": "image_79.png",
                    "theta_right": "217"
                  },
                  {
                    "block_n": "3",
                    "image_left": "image_80.png",
                    "hue_left": "265",
                    "theta_left": "97",
                    "image_right": "image_80.png",
                    "theta_right": "97"
                  },
                  {
                    "block_n": "3",
                    "image_left": "image_81.png",
                    "hue_left": "73",
                    "theta_left": "121",
                    "image_right": "image_81.png",
                    "theta_right": "121"
                  },
                  {
                    "block_n": "3",
                    "image_left": "image_82.png",
                    "hue_left": "121",
                    "theta_left": "49",
                    "image_right": "image_82.png",
                    "theta_right": "49"
                  },
                  {
                    "block_n": "3",
                    "image_left": "image_83.png",
                    "hue_left": "241",
                    "theta_left": "193",
                    "image_right": "image_83.png",
                    "theta_right": "193"
                  },
                  {
                    "block_n": "3",
                    "image_left": "image_84.png",
                    "hue_left": "169",
                    "theta_left": "73",
                    "image_right": "image_84.png",
                    "theta_right": "73"
                  },
                  {
                    "block_n": "3",
                    "image_left": "image_85.png",
                    "hue_left": "289",
                    "theta_left": "313",
                    "image_right": "image_85.png",
                    "theta_right": "313"
                  },
                  {
                    "block_n": "3",
                    "image_left": "image_86.png",
                    "hue_left": "217",
                    "theta_left": "265",
                    "image_right": "image_86.png",
                    "theta_right": "265"
                  },
                  {
                    "block_n": "3",
                    "image_left": "image_87.png",
                    "hue_left": "145",
                    "theta_left": "169",
                    "image_right": "image_87.png",
                    "theta_right": "169"
                  },
                  {
                    "block_n": "3",
                    "image_left": "image_88.png",
                    "hue_left": "337",
                    "theta_left": "217",
                    "image_right": "image_88.png",
                    "theta_right": "217"
                  },
                  {
                    "block_n": "3",
                    "image_left": "image_89.png",
                    "hue_left": "3",
                    "theta_left": "5",
                    "image_right": "image_89.png",
                    "theta_right": "5"
                  },
                  {
                    "block_n": "3",
                    "image_left": "image_90.png",
                    "hue_left": "25",
                    "theta_left": "289",
                    "image_right": "image_90.png",
                    "theta_right": "289"
                  },
                  {
                    "block_n": "3",
                    "image_left": "image_91.png",
                    "hue_left": "193",
                    "theta_left": "241",
                    "image_right": "image_91.png",
                    "theta_right": "241"
                  },
                  {
                    "block_n": "3",
                    "image_left": "image_92.png",
                    "hue_left": "97",
                    "theta_left": "25",
                    "image_right": "image_92.png",
                    "theta_right": "25"
                  },
                  {
                    "block_n": "3",
                    "image_left": "image_93.png",
                    "hue_left": "49",
                    "theta_left": "337",
                    "image_right": "image_93.png",
                    "theta_right": "337"
                  },
                  {
                    "block_n": "3",
                    "image_left": "image_94.png",
                    "hue_left": "313",
                    "theta_left": "145",
                    "image_right": "image_94.png",
                    "theta_right": "145"
                  }
                ],
                "sample": {
...
// LEFT CIRCLE AND IMAGE

this.state.imgHeight_left

// transform the deg to radians (because of Math.cos and Math.sin)
var thetaR_left = this.parameters.theta_left * Math.PI/180
...
var xPos_left = (this.state.radius_left * Math.cos(thetaR_left)) + this.state.imgShift_left 
var yPos_left = (this.state.radius_left * Math.sin(thetaR_left)) + this.state.imgShift_left

// save coordinates
this.options.datastore.set('imgPosX_left', xPos_left)
this.options.datastore.set('imgPosY_left', yPos_left)

// send it to html object to present
document.getElementById('image_location_left').style.left = xPos_left  + "px"
document.getElementById('image_location_left').style.top  = yPos_left + "px"

// RIGHT CIRCLE AND IMAGE

document.getElementById('image_location_right').style.top  =  0 + this.state.imgShift_right  + "px"
document.getElementById('image_location_right').style.left =  0 + this.state.imgShift_right  + "px"
},
                        "before:prepare": function anonymous(
) {
// prepare modulus function
Number.prototype.mod = function (n) {
  ...
  this.options.events['mousedown'] = function(e) {
    isPicking = true // need to get position already here
      offsetX = document.getElementById('image_location_right').offsetLeft - e.clientX
      offsetY = document.getElementById('image_location_right').offsetTop  - e.clientY
          }
  ...
  // what happens when mouse is moving over the grey circle area
  this.options.events['mousemove #locationCircle_right'] = function(event) {
    if (isPicking) {
  
      // set position of image to where the mouse is. it is for upper left corner of the image.
      document.getElementById('image_location_right').style.left = (event.clientX + offsetX) + "px"
      document.getElementById('image_location_right').style.top = (event.clientY + offsetY)   + "px"
      
      // we need to take the relation to circle and take the center of object (now we subtract)
      this.parameters.imgPosXTest_right = (event.clientX + offsetX) - this.state.imgShift_right 
      this.parameters.imgPosYTest_right = (event.clientY + offsetY) - this.state.imgShift_right
  
      let imageRadius = Math.sqrt(Math.pow(this.parameters.imgPosXTest_right, 2) + Math.pow(this.parameters.imgPosYTest_right, 2));
  ...
  // calculate angle in radians
  const locAngleRadians = Math.atan2(this.parameters.imgPosYTest_right, this.parameters.imgPosXTest_right)
  
  // transform from radians to degrees
  const locAngleDegrees = locAngleRadians * 180 / Math.PI
  
  // save location adjustments etc NOTE: IF YOU HAVE TWO COMPONENTS FOR LOCATION AND COLOUR, YOU COULD HAVE THE SAME VARIABLE NAMES. THEN IT WOULD BE SAVED IN THE SAME COLUMN BUT YOU CAN FILTER AFTER THE NAME OF THE COMPONENT LATER. YOU CAN ALSO FILTER FOR COMPONENT WHEN READING IT OUT OF THE DATASTORE FOR FEEDBACK LATER. 
  this.data.location_angle_study = this.parameters.theta_right
  this.data.location_angle_test =  locAngleDegrees
  this.data.location_angle_deviation = (((this.data.location_angle_study - this.data.location_angle_test) + 180).mod(360)) - 180
  this.data.location_angle_abs_deviation = Math.abs(this.data.location_angle_deviation)
    }
  ...
  const setVisibility = (selector, isVisible) => {
    ...
    isButtonVisible = isVisible ? true : false
                      ...
                      "title": "Location_Recall_VP",
                      "content": "\u003Cmain class=\"content-vertical-center content-horizontal-center\"\u003E\n\n  \u003Cdiv class = \"pickparent\" style= \"margin-left: 50px;\"\u003E\n     \u003Csvg class=\"pickpicker\"\n          height =\"${ this.state.diameter_left }\" width=\"${ this.state.diameter_left }\" \n          viewbox=\"0 0 ${ this.state.diameter_left } ${ this.state.diameter_left }\"\u003E\n          \u003C!–– keep scaling similar for object with: preserveAspectRatio =\"xMinYMin meet\", put it back bfore viewbox if needed --\u003E\n       \u003Ccircle\n          id=\"locationCircle_left\"\n          cx=\"${ this.state.radius_left }\" cy=\"${ this.state.radius_left }\" r=\"${ this.state.radius_left }\"\n          style=\"fill: black\"\n        \u002F\u003E\n        \u003Ccircle\n          id=\"locationCircle_left\"\n          cx=\"${ this.state.radius_left }\" cy=\"${ this.state.radius_left }\" r=\"${ this.state.radius1_left }\"\n          style=\"fill: #f2f2f2\"\n        \u002F\u003E\n        \u003Ccircle\n          id=\"locationCircle_left\"\n          cx=\"${ this.state.radius_left }\" cy=\"${ this.state.radius_left }\" r=\"${ this.state.radius2_left }\" \n          style=\"fill: black\"\n        \u002F\u003E\n        \u003Ccircle\n          id=\"locationCircle_left\"\n          cx=\"${ this.state.radius_left }\" cy=\"${ this.state.radius_left }\" r=\"${ this.state.radius3_left }\" \n          style=\"fill: white\"\n        \u002F\u003E\n      \u003C\u002Fsvg\u003E\n\n      \u003Cimg id=\"image_location_left\" class='pickimage' src=\"static\u002F${this.parameters.image_left}\"    \n       style = 'position: absolute;z-index: 2;height: ${this.state.imgHeight_left + \"px\"}; pointer-events: none; filter: hue-rotate(${this.parameters.hue_left}deg)'\u003E\n\n  \u003C\u002Fdiv\u003E\n\n\u003Cdiv class=\"pickparent\" style=\"margin-left: 300px;\"\u003E\n    \u003C!-- Second Circle (Circle on the right) --\u003E\n    \u003Csvg class=\"pickpicker\"\n         height=\"${this.state.diameter_right}\" width=\"${this.state.diameter_right}\"\n         viewbox=\"0 0 ${this.state.diameter_right} ${this.state.diameter_right}\"\u003E\n      \u003C!-- Circle elements for the second circle --\u003E\n      \u003C!-- ... --\u003E\n\n      \u003Ccircle\n          id=\"locationCircle_right\"\n          cx=\"${ this.state.radius_right }\" cy=\"${ this.state.radius_right }\" r=\"${ this.state.radius_right }\"\n          style=\"fill: black\"\n        \u002F\u003E\n        \u003Ccircle\n          id=\"locationCircle_right\"\n          cx=\"${ this.state.radius_right }\" cy=\"${ this.state.radius_right }\" r=\"${ this.state.radius1_right }\"\n          style=\"fill: #f2f2f2\"\n        \u002F\u003E\n        \u003Ccircle\n          id=\"locationCircle_right\"\n          cx=\"${ this.state.radius_right }\" cy=\"${ this.state.radius_right }\" r=\"${ this.state.radius2_right }\" \n          style=\"fill: black\"\n        \u002F\u003E\n        \u003Ccircle\n          id=\"locationCircle_right\"\n          cx=\"${ this.state.radius_right}\" cy=\"${ this.state.radius_right }\" r=\"${ this.state.radius3_right }\" \n          style=\"fill: white\"\n        \u002F\u003E\n      \u003C\u002Fsvg\u003E\n\n      \u003Cimg id=\"image_location_right\" class='pickimage' src=\"static\u002F${this.parameters.image_right}\"    \n       style = 'height: ${this.state.imgHeight_right + \"px\"}; pointer-events: none;'\u003E\n\n  \u003C\u002Fdiv\u003E\n\u003C\u002Fmain\u003E\n\n\u003Cfooter\u003E\n  \u003Cp id=\"fwd\"\u003E\n  Keep left mouse button pressed and move object to set LOCATION on circle.\n  \u003C\u002Fp\u003E\n  \u003Cbutton id=\"cmt\" style=\"visibility: hidden\"\u003E\n    Confirm selected LOCATION and continue\n  \u003C\u002Fbutton\u003E\n\u003C\u002Ffooter\u003E\n\n\n\n\n\n",
                      "tardy": true,
                      "skip": "${this.state.counterbalancing != 1}"
                    },
                    {
...
this.parameters.hue_left = this.parameters.hue_left
...
let isPicking = false;
let dummy_button = 999;
let offset = Math.random() * 360 - 180;
...
this.options.events['mousemove #colorCircle_right'] = function(event) {
  if (isPicking) {
    const centerX = this.state.radius_right;
    const centerY = this.state.radius_right;
    const mouseX = event.offsetX;
    const mouseY = event.offsetY;
    
    // Compute the angle relative to the center of the circle
    const angleRadians = Math.atan2(mouseY - centerY, mouseX - centerX);
    const angleDegrees = (angleRadians * 180) / Math.PI;

    // Compute the color angle by adding the offset
    const colorAngle = (((angleDegrees + offset) + 180).mod(360)) - 180;

    // Apply color to the preview image using hue-rotate
    const preview = this.options.el.querySelector('#image_color_right');
    preview.style.filter = `hue-rotate(${colorAngle}deg)`;
    
    dummy_button = 1;
    
    // Save color adjustments
    this.data.color_offset = offset;
    this.data.color_angle_study = this.parameters.hue_left;
    this.data.color_angle_test = colorAngle;
    this.data.color_angle_deviation = (((this.data.color_angle_study - this.data.color_angle_test) + 180).mod(360)) - 180;
    this.data.color_angle_abs_deviation = Math.abs(this.data.color_angle_deviation);
  }
...
// send it to html object to present
document.getElementById('image_color_left').style.left = xPos_left  + "px"
document.getElementById('image_color_left').style.top  = yPos_left + "px"

// RIGHT CIRCLE AND IMAGE

document.getElementById('image_color_right').style.top  =  0 + this.state.imgShift_right  + "px"
document.getElementById('image_color_right').style.left =  0 + this.state.imgShift_right  + "px"
...
document.getElementById('image_color_right').style.left =  0 + this.state.imgShift_right + "px"
                      ...
                      "title": "Colour_Recall_VP",
                      "content": "\u003Cmain class=\"content-vertical-center content-horizontal-center\"\u003E\n\n  \u003Cdiv class = \"pickparent\" style= \"margin-left: 50px\"\u003E\n     \u003Csvg class=\"pickpicker\"\n          height =\"${ this.state.diameter_left }\" width=\"${ this.state.diameter_left }\" \n          viewbox=\"0 0 ${ this.state.diameter_left } ${ this.state.diameter_left }\"\u003E\n          \u003C!–– keep scaling similar for object with: preserveAspectRatio =\"xMinYMin meet\", put it back bfore viewbox if needed --\u003E\n       \u003Ccircle\n          id=\"colorCircle_left\"\n          cx=\"${ this.state.radius_left }\" cy=\"${ this.state.radius_left }\" r=\"${ this.state.radius_left }\"\n          style=\"fill: black\"\n        \u002F\u003E\n        \u003Ccircle\n          id=\"colorCircle_left\"\n          cx=\"${ this.state.radius_left }\" cy=\"${ this.state.radius_left }\" r=\"${ this.state.radius1_left }\"\n          style=\"fill: #f2f2f2\"\n        \u002F\u003E\n        \u003Ccircle\n          id=\"colorCircle_left\"\n          cx=\"${ this.state.radius_left }\" cy=\"${ this.state.radius_left }\" r=\"${ this.state.radius2_left }\" \n          style=\"fill: black\"\n        \u002F\u003E\n        \u003Ccircle\n          id=\"colorCircle_left\"\n          cx=\"${ this.state.radius_left }\" cy=\"${ this.state.radius_left }\" r=\"${ this.state.radius3_left }\" \n          style=\"fill: white\"\n        \u002F\u003E\n      \u003C\u002Fsvg\u003E\n\n      \u003Cimg id=\"image_color_left\" class='pickimage' src=\"static\u002F${this.parameters.image_left}\"    \n       style = 'position: absolute;z-index: 2;height: ${this.state.imgHeight_left + \"px\"}; pointer-events: none; filter: hue-rotate(${this.parameters.hue_left}deg)'\u003E\n\n  \u003C\u002Fdiv\u003E\n\n\u003Cdiv class=\"pickparent\" style=\"margin-left: 300px;\"\u003E\n    \u003C!-- Second Circle (Circle on the right) --\u003E\n    \u003Csvg class=\"pickpicker\"\n         height=\"${this.state.diameter_right}\" width=\"${this.state.diameter_right}\"\n         viewbox=\"0 0 ${this.state.diameter_right} ${this.state.diameter_right}\"\u003E\n      \u003C!-- Circle elements for the second circle --\u003E\n      \u003C!-- ... --\u003E\n\n      \u003Ccircle\n          id=\"colorCircle_right\"\n          cx=\"${ this.state.radius_right }\" cy=\"${ this.state.radius_right }\" r=\"${ this.state.radius_right }\"\n          style=\"fill: black\"\n        \u002F\u003E\n        \u003Ccircle\n          id=\"colorCircle_right\"\n          cx=\"${ this.state.radius_right }\" cy=\"${ this.state.radius_right }\" r=\"${ this.state.radius1_right }\"\n          style=\"fill: #f2f2f2\"\n        \u002F\u003E\n        \u003Ccircle\n          id=\"colorCircle_right\"\n          cx=\"${ this.state.radius_right }\" cy=\"${ this.state.radius_right }\" r=\"${ this.state.radius2_right }\" \n          style=\"fill: black\"\n        \u002F\u003E\n        \u003Ccircle\n          id=\"colorCircle_right\"\n          cx=\"${ this.state.radius_right}\" cy=\"${ this.state.radius_right }\" r=\"${ this.state.radius3_right }\" \n          style=\"fill: white\"\n        \u002F\u003E\n      \u003C\u002Fsvg\u003E\n\n      \u003Cimg id=\"image_color_right\" class='pickimage' src=\"static\u002F${this.parameters.image_right}\"    \n       style = 'height: ${this.state.imgHeight_right + \"px\"}; pointer-events: none;'\u003E\n\n  \u003C\u002Fdiv\u003E\n\u003C\u002Fmain\u003E\n\n\u003Cfooter\u003E\n  \u003Cp id=\"fwd\"\u003E\n  Keep left mouse button pressed and move the mouse over the circle to set COLOUR.\n  \u003C\u002Fp\u003E\n  \u003Cbutton id=\"cmt\" style=\"visibility: hidden\"\u003E\n    Confirm selected COLOUR and continue\n  \u003C\u002Fbutton\u003E\n\u003C\u002Ffooter\u003E\n\n\n\n",
                      "tardy": true
                    },
                    {
                      "type": "lab.html.Screen",
...
// filter by Location_Recall
const location_filtered_data = this.options.datastore.data.filter(
  row => row.sender === 'Location_Recall_VP' && row.ended_on !== 'skipped' && row.block === this.parameters.block
);

// filter by Colour_Recall
const color_filtered_data = this.options.datastore.data.filter(
  row => row.sender === 'Colour_Recall_VP' && row.ended_on !== 'skipped' && row.block === this.parameters.block
);
                ...
                "items": [
                  {
                    "type": "text",
                    "title": "\u003Cheader\u003E \u003Ch1\u003EBreak \u003C\u002Fheader\u003E \u003C\u002Fh1\u003E",
                    "content": "\u003Cp style=\"font-size: 28px; text-align: center;\"\u003EGreat! Please take a short break before moving on to the next screen.\u003C\u002Fp\u003E\n"
                  }
                ],
                "scrollTop": true,
                "submitButtonText": "Next →",
          ...
          "items": [
            {
              "required": true,
              "type": "html",
              "content": "\u003Cheader\u003E\r\n  \u003Ch1 id=\"instructionHeader\"\u003EMotivation Questionnaire\u003C\u002Fh1\u003E\r\n\u003C\u002Fheader\u003E\r\n\u003Cp style=\"font-size: 24px; position: center\"\u003E Thank you for completing the computerised memory and matching tasks. The final section asks about what motivated you to complete the research. It will only take a few minutes. Click \"Next\" to move on. \u003C\u002Fp\u003E",
              "name": ""
            }
          ],
          "scrollTop": true,
