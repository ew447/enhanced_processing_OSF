...
# Part 1.  The R functions of del Giudice, inserted without any change
# Part 2.  Reading in synaesthesia data from excel and running it through the functions
# Part 3.  Simulated data (a single variable in noise) running through the function
