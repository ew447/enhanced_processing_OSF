...
run_syn_covariate_analysis <- FALSE  # Change to TRUE to run separate syn-only analysis, though refer to scripts with suffix numtypes for more precise analysis
